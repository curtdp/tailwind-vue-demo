<template>
  <div id="app">
  <div class="flex">
    <div class="lg:w-1/2 max-w-xl mx-auto lg:ml-auto lg:mr-0 px-6 py-8 ">
      <svg class="w-64 mt-4" viewBox="0 0 185 32" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <img class="mt-8 block rounded-lg shadow-2xl lg:hidden" src="beach-work.jpg" alt="">
      <h1 class="mt-6 text-4xl font-bold leading-tight text-gray-900">You can work from anywhere.
      ...
      <div class="mt-4">
        <a href="#" class="btn btn-indigo mr-2">Book your escape</a>
        <a href="#" class="btn btn-gray">Learn more</a>
      </div>
    </div>
    <div class="hidden lg:w-1/2 lg:block">
        <img class="" src="beach-work.jpg" alt="">
    </div>



  </div>
  <div class="cards mb-24 max-w-xl md:max-w-full mx-auto px-6 mt-4">
      <div class="" v-for="card of cards" :key="card.image">
        <Card :cardData="card" />
      </div>
    </div>
  </div>
...
export default {
  ...
  data() {
    return {
      cards: [
        {
          image: "https://images.unsplash.com/photo-1538097304804-2a1b932466a9?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=100&q=80",
          price: '130',
          city: 'Seattle',
          propCount: 47
        },
        {
          image: "https://images.unsplash.com/photo-1519424187720-db6d0fc5a5d2?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=100&q=80",
          price: '120',
          city: 'Denver',
          propCount: 32
        }
